...
export const getProductsInCart = (userId: string) => (dispatch) => {
  if (!userId) {
...
export const addProductInCart = (userId, product) => (dispatch) => {
  if (!userId) {
...
export const deleteProductFromCart = (userId, id) => (dispatch) => {
  if (!userId) {
