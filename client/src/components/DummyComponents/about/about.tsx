...
import angelo from '../../../img/angelo.jpg';
...
},
{
  ...
  profilePicture: martin,
}, {
  name: 'Federico',
  lastName: 'Giovenco',
  role: 'Full Stack Developer',
  linkedIn: 'https://www.linkedin.com/in/federico-giovenco-96929320b/',
  gitHub: 'https://github.com/IamCocoDev',
  profilePicture: federico,
}];
