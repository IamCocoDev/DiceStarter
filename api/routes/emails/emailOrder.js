function template(first, last, totalPrice) {
  return `
      <!DOCTYPE html>
  <html>
  <head>
                  ...
                  <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                      <tr>
                          <td bgcolor="#000000" align="center" valign="top" style="padding: 40px 20px 20px 20px; border-radius: 4px 4px 0px 0px; color: #ffffff; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 48px; font-weight: 400; letter-spacing: 4px; line-height: 48px;">
                              ...
                              Thanks ${`${first.charAt(0).toUpperCase() + first.slice(1)} ${last.charAt(0).toUpperCase()}${last.slice(1)} `}for your purchase!</h1> 
                          </td>
                      </tr>
                  </table>
              </td>
          ...
          <tr>
              <td bgcolor="#101010" align="center" style="padding: 0px 10px 0px 10px;">
                  ...
                  <td bgcolor="#000000" align="left" style="padding: 20px 30px 40px 30px; color: #CCCCCC; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 400; line-height: 25px;">
                      <p style="margin: 0;">Your purchase of $${totalPrice} has been confirmed and your order is being sent to your address. Thank you very much!. Just press the button below.</p>
                  </td>  
              </tr>
              <tr>
